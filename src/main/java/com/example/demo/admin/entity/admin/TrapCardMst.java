...
public class TrapCardMst {
    ...
    public String getTRAP_KIND() {
        return TRAP_KIND;
    }

    public void setTRAP_KIND(String TRAP_KIND) {
        this.TRAP_KIND = TRAP_KIND == null ? null : TRAP_KIND.trim();
    }
